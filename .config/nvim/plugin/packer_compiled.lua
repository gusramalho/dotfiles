...
_G.packer_plugins = {
  ...
  ["cmp-buffer"] = {
    loaded = true,
    path = "/home/gustavo/.local/share/nvim/site/pack/packer/start/cmp-buffer",
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/gustavo/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
    url = "https://github.com/hrsh7th/cmp-nvim-lua"
  },
  ["cmp-path"] = {
    loaded = true,
    path = "/home/gustavo/.local/share/nvim/site/pack/packer/start/cmp-path",
    url = "https://github.com/hrsh7th/cmp-path"
  },
  cmp_luasnip = {
    loaded = true,
    path = "/home/gustavo/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/gustavo/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
